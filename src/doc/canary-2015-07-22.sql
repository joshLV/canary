...
CREATE TABLE `t_website` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='站点基础信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-07-22 20:40:51
