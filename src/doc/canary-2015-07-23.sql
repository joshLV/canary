...
CREATE TABLE `t_log` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_user` VALUES (1,'canary','canary','MsAFxQBLFpXRMFmQBIMuGA==','您自己的姓名是','canary','Super','1234567890','canary@qq.com','18688888888','10000','Man',20,'2000-01-01 00:00:00','/static/image/default.png','UnBound','UnBound',2,'Eanble','NotDelete','canary','2015-07-23 18:13:49','canary','2000-01-01 12:00:00'),(2,'china','china','Vff8xTZFJez8JxiiItGgUA==','您自己的姓名是','china','Admin','180ae910811f46e8a4e160df3b146e9d','china@qq.com','110','10000','Secret',25,'2000-01-01 12:00:00','/static/image/default.png','UnBound','UnBound',0,'Eanble','NotDelete','china','2015-06-14 15:54:21','china','2000-01-01 12:00:00'),(3,'xiaozhi','xiaozhi','CzaH7JWzg0iPMIopLsq1cw==','您自己的姓名是','xiaozhi','User','1234567890','xiaozhi@qq.com','120','20000','Man',20,'2000-01-01 00:00:00','/static/image/default.png','UnBound','UnBound',0,'Eanble','NotDelete','xiaozhi','2015-07-23 18:24:30','xiaozhi','2000-01-01 12:00:00'),(4,'spring','spring','aOqWus/z/IfPsaZyN4E/7Q==','您自己的姓名是','spring','User','52c7bb16f2a742d48cf8abb5490e6703','spring@qq.com','18600000000',NULL,'Secret',NULL,NULL,'/static/image/default.png','UnBound','UnBound',0,'Enable','Delete','canary','2015-06-14 00:37:50','canary','2015-06-14 00:11:04');
...
INSERT INTO `t_website` VALUES (1,'title','金丝雀','网站标题','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(2,'description','金丝雀','网站描述','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(3,'keywords','金丝雀，金雀','网站关键字','NotDelete','system','2015-04-29 16:47:10','system','2015-04-01 12:00:00'),(4,'url','www.canary.com','网站网址','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(6,'email','canary@qq.com','网站邮箱','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(7,'icp','京ICP证030173号','网站备案号','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(8,'meta','<script>console.log(\'website.script\');</script>','网站统计代码','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(9,'about','关于我们','关于我们','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(10,'contact','联系我们','联系我们','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(11,'contribution','投稿','投稿','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(12,'copyright','版权声明','版权声明','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(13,'link','友情链接','友情链接','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(14,'topAd','</script><script type=\'text/javascript\' src=\'http://images.sohu.com/cs/jsfile/js/c.js\'></script>','上部广告','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(15,'centerAd','</script><script type=\'text/javascript\' src=\'http://images.sohu.com/cs/jsfile/js/c.js\'></script>','中间广告','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(16,'bottomAd','</script><script type=\'text/javascript\' src=\'http://images.sohu.com/cs/jsfile/js/c.js\'></script>','下部广告','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00'),(17,'rightAd','</script><script type=\'text/javascript\' src=\'http://images.sohu.com/cs/jsfile/js/c.js\'></script>','右侧广告','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00');
...
-- Dump completed on 2015-07-23 18:31:02
