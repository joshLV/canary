...
INSERT INTO `t_administrator` VALUES (1,'canary','MsAFxQBLFpXRMFmQBIMuGA==','您自己的姓名是','canary','1234567890','canary@qq.com','110','NotDelete','system','2015-04-01 12:00:00','system','2015-04-01 12:00:00');
/*!40000 ALTER TABLE `t_administrator` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_administrator_login_log`
--

DROP TABLE IF EXISTS `t_administrator_login_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_administrator_login_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
--
-- Dumping data for table `t_administrator_login_log`
--

LOCK TABLES `t_administrator_login_log` WRITE;
/*!40000 ALTER TABLE `t_administrator_login_log` DISABLE KEYS */;
INSERT INTO `t_administrator_login_log` VALUES (13,'canary','canary123','您自己的姓名是','canary','登陆失败','未分配或者内网IP####','127.0.0.1','NotDelete','system','2015-04-29 12:36:12','system','2015-04-29 12:36:12'),(14,'canary','保密','您自己的姓名是','canary','登陆成功','','','NotDelete','system','2015-04-29 12:36:48','system','2015-04-29 12:36:48');
/*!40000 ALTER TABLE `t_administrator_login_log` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-05-07 18:50:07
